package com.springlesson.clinicadmin.examples.entity;
...
public class AnimalShelter extends AutoIncrementIdentity {
    ...
    @Column(name = "is_active",// название столбца
            ...
            insertable = false) // столбец не будет фигурировать в формируемых spring data.sql INSERT запросах
    private boolean isActive;

    @CreatedDate // заполняется датой создания сущности
    @Column(name = "created_at", // название столбца
            updatable = false) // столбец не будет фигурировать в формируемых spring data.sql UPDATE запросах
